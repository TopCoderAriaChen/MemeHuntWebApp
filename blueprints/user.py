...
def mail_captcha():
  try:
    ...
    subject="Registration verification code for Meme Hunt:"
    body = f"Registration verification code for Meme Hunt:{captcha}, Please do not tell/send this code to anyone!"
